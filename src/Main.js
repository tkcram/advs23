    ...
    <main className={classes.main}>
      ...
      <GraphicContainer onStepEnter={lineEnter} onStepExit={lineExit} onStepProgress={lineProgress} graphicComponent={<Lines setStep={data}/>} alignment="left">
        ...
        <Step data="staff_per_year">
          <div className={classes.step}>  
            <p>Knudstorp, an economics PhD., had previously worked as a consultant for McKinsey & Company. To return the company to a profitable state, he introduced three key initiatives: Stabilise the business by reducing overhead, go ‘back to the brick’ with their design philosophy, and move into previously untapped ‘blue ocean’ markets.</p>
      ...
      <p>Knudstorp’s leadership and direction for the company proved incredibly successful. During his tenure as CEO from 2004-2017 the company saw a 500% increase in revenue, from 6,296mDKK to 34,955mDKK, with an average operating profit of 6,152mDKK. Even after he stepped down in 2017, the trajectory of the company continued upwards. As of this writing, LEGO is the largest toy company in the world with a revenue of 8b USD, beating out the likes of Bandai-Namco(7.56b USD), Hasbro (5.85b USD), and Mattel (5.4b USD).</p>
